...
router.post("/expenseSummery", authMiddelware.authMiddelware, validationMiddleware.validateRequest(expenseValidation.summarySchema), expensesController.expenseSummary);
